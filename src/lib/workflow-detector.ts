...
export class WorkflowDetector {
  detectWorkflow(messages: any[]): WorkflowDetectionResult {
    ...
    const actionCount = actionWords.filter(action => 
  ...
  private generateWorkflowName(content: string): string {
  ...
  private generateWorkflowDescription(content: string): string {
