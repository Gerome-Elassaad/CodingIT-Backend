...
async function GET(request) {
    try {
        ...
        if (!response.ok) {
            ...
            return server_1.NextResponse.json({ error: 'Failed to fetch repositories' }, { status: 500 });
        }
        ...
        const usageInfo = await (0, usage_tracker_1.checkFeatureAccess)(session.user.id, 'github_imports');
